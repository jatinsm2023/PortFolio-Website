...
import { Search, Calculator, Calendar, CreditCard, Settings, User, Globe, Briefcase, Terminal, Mail, Image, StickyNote, Music2, Gamepad2, Palette, Sparkles } from "lucide-react";
